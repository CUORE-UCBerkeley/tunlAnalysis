...
int main(){
    ...
    std::vector<TH1D *> hAmpToFCorr; //contains ToF corrected amplitude spectra
    ...
    for(int i = 0; i < 4; i++){
        ...
        hAmpRaw.push_back(new TH1D(Form("hAmpRaw%d", kk),Form("hAmpRaw%d", kk),10000,0,60000));
